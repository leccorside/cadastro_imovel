...
@IonicPage()
@Component({
  selector: 'page-novocliente10',
  templateUrl: 'novocliente10.html',
})
export class Novocliente10Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Novocliente10Page');
  }
  ...
  proximo1(){
    ...
    let body = {
      ...
      img_comp_end_cliente: this.cameraData1,
      aksi: 'salvarcompresidencia'
    };
    ...
    this.apiProvider.postData(body, 'api.php').subscribe((data) => {
      ...
      if(data.success){
            ...
            this.navCtrl.setRoot(Novocliente11Page, {
              email_cliente:this.email_cliente,
