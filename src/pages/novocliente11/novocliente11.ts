...
@IonicPage()
@Component({
  selector: 'page-novocliente11',
  templateUrl: 'novocliente11.html',
})
export class Novocliente11Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Novocliente11Page');
  }
  ...
  proximo1(){
    ...
    let body = {
      ...
      img_comp_rend_cliente: this.cameraData1,
      aksi: 'salvarcomprendementos'
    };
    ...
    this.apiProvider.postData(body, 'api.php').subscribe((data) => {
      ...
      if(data.success){
            ...
            this.navCtrl.setRoot(Novocliente12Page, {
              email_cliente:this.email_cliente,
