...
@IonicPage()
@Component({
  selector: 'page-novocliente13',
  templateUrl: 'novocliente13.html',
})
export class Novocliente13Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Novocliente13Page');
  }
  ...
  proximo1(){
    ...
    let body = {
      ...
      img_iptu_cliente: this.cameraData1,
      aksi: 'salvariptuimovel'
    };
    ...
    this.apiProvider.postData(body, 'api.php').subscribe((data) => {
      ...
      if(data.success){
            ...
            this.navCtrl.setRoot(Novocliente14Page, {
              email_cliente:this.email_cliente,
