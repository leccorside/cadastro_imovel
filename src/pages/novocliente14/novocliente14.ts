...
@IonicPage()
@Component({
  selector: 'page-novocliente14',
  templateUrl: 'novocliente14.html',
})
export class Novocliente14Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Novocliente14Page');
  }
  ...
  proximo1(){
    ...
    let body = {
      ...
      img_facha_cliente: this.cameraData1,
      aksi: 'salvarfachadaimovel'
    };
