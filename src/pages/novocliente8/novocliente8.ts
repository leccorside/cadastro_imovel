...
@IonicPage()
@Component({
  selector: 'page-novocliente8',
  templateUrl: 'novocliente8.html',
})
export class Novocliente8Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Novocliente8Page');
  }
  ...
  proximo1(){
    ...
    let body = {
      ...
      img_cert_casa_cliente: this.cameraData1,
      aksi: 'salvarcertcasamento'
    };
    ...
    this.apiProvider.postData(body, 'api.php').subscribe((data) => {
      ...
      if(data.success){
            ...
            this.navCtrl.setRoot(Novocliente9Page, {
              email_cliente:this.email_cliente,
